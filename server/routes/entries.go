...
import (
	...
	"github.com/Tejas24ytj/Go-Calorie-Tracker-App/models"
...
func AddEntry(c *gin.Context) {
	...
	if insertErr != nil {
		msg := fmt.Sprintf("Order Item was not Received")
...
func UpdateIngredient(c *gin.Context) {
    ...
    result,err:=entryCollection.UpdateOne(ctx,bson.M{"id":docID}
